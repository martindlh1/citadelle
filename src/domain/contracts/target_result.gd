...
##
## Une acceptation porte deux choses que la validation a calculées de toute façon, et que
## l'action posée gardera figées : **où** l'action se joue — à cru ou dans un bâtiment —
## et **combien** d'ouvriers elle accepte. Les faire recalculer plus tard ouvrirait la
## porte à ce que l'écran promette trois postes et que le soir n'en serve que deux.
...
## Ciblage accepté : l'action se poserait de cette façon, et accepterait tant d'ouvriers.
##
...
static func accepted(kind: PlayedAction.Kind, capacity: int) -> TargetResult:
